...
//if (isset($_POST['prodsave'])){
	...
	mysql_query("INSERT INTO products(prod_name,category_id,pro_description,starting_bid,prod_image,regularprice,date_posted,due_date,status) 
