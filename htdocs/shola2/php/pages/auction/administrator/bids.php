                        ...
                        <h5></h5>
						  <h5>Products on bid</h5>
							...
							<?php
								...
								{
								echo "<li>";
								echo "<a href = 'bidlist.php?id=".$row['product_id']."' rel='facebox' title='Product Name: ".$row['prod_name']." Regular Price: P"." Description: ".$row['pro_description']." Click to view log.'><img src ='images/products/".$row['prod_image']."' width='72' height='72' alt='' ></a>";
								echo "</li>";
								}
							?>
                                    </ul>
