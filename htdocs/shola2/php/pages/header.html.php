    ...
    <header class="no-margin-left no-margin-right no-margin-top">
        <div class="bg-darker">
            <a class="place-left" href="<?php echo getRootPath(); ?>" title="" style="margin-left:10px">
              ...
              <h1>Shola E-commerce .. Big Logo, And Big Text to the right</h1>
              </span>
            </a>
        </div>
            ...
            <div class="place-right">
                <form action = "<?php echo getRootPath().'php/pages/search/search.html.php';?>">
                    <div class="input-control text margin20" style="width: 300px">
                        ...
                        <br>
                        <a href="<?php echo getRootPath().'php/pages/search/advanced_search.html.php';?>" class="place-right padding10 no-padding-right link" >Advanced Search</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="main-menu-wrapper">
          ...
          <?php
                if(userIsLoggedIn()){
          ?>
          <li><a href="<?php echo getRootPath().'php/pages/forum/main_forum.html.php'; ?>">Community</a></li>
          <?php } ?>
          <li><a href="<?php echo getRootPath().'contact.php'; ?>">Contact Us</a></li>
          <li><a href="<?php echo getRootPath().'about.php'; ?>">About Us</a></li>
          ...
          <li class="place-right">
            ...
            <ul class="d-menu place-right" data-role="dropdown">
                ...
                ?>
                        ...
                        <li><a href="php/pages/register.html.php" >Signup</a></li>
                <?php 
                    }
                ?>
