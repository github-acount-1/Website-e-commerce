<?php
	...
	if(isset($_POST['cancel'])){
		header("Location: ".getRootPath().'php/pages/item/item_info.html.php?id='.$id.'&cid='.Category::getItemsCategory($id));
	}
...
<div class="row cells">
  ...
  <form id="question_form" action="<?php echo $_SERVER['PHP_SELF'].'?id='.$id;?>" method="post">
      ...
      <select name="keywords[0][]" id="select1" style display="none" multiple></select>
			...
			<button class="button rounded primary" name="cancel">Finish</button>
      <br>
