...
//public function submitItemMethod(){
    ...
    $category=new category();
		...
		if($postFormSubmitted){
			...
			$sql="INSERT INTO items(item_name,description,quantity,category,post_date,contract_Period,price) VALUES (:itemName,
				:description,:quantity,:cat,:postDate,:availability,:price)";
			try{
