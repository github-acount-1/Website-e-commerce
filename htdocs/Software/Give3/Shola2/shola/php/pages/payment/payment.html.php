            ...
            case 0:
                ...
                if(isset($_GET['check_box']))
				  ...
				  if(canSplitPay($itemId,$check,$pdo)){
					  ...
					  //makeReceipt($money, $userId, $itemId, $payment_type, $pdo);
				  }
            ...
            <div class="col-md-4 col-md-offset-4 col-xs-12">
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="/shola/payment.php" method="post" id="payment-form">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="credit_card" type="tel" required="" placeholder="Valid Card Number" id="cardNumber">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" id="couponCode" name='expiration_date'>
                                    </div>
                                </div>
                            ...
                            <div class ="row">
								<div class="col-xs-12">
									<div class="checkbox">
										...
										<input type="checkbox" name="mycheckbox" id='mycheckbox' value="">Use Split pay. <a href="terms.php"> Terms of policy</a></label>	
