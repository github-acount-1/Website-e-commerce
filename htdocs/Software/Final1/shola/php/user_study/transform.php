<?php
	require_once $_SERVER['DOCUMENT_ROOT'].'shola/php/includes/helpers_inc.php';				//this includes helper function that everyone has access to
	require_once $_SERVER['DOCUMENT_ROOT'].'shola/php/classes/user.class.php';
	require_once $_SERVER['DOCUMENT_ROOT'].'shola/php/includes/db_inc.php';	//this includes the database connection using a pdo interface and returns $pdo variable
	@session_start();
	if(!userIsLoggedIn()){
