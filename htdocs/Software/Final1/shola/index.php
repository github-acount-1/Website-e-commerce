<?php
    require_once $_SERVER['DOCUMENT_ROOT'].'/Software/Final1/shola/php/includes/helpers_inc.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/Software/Final1/shola/php/includes/db_inc.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/Software/Final1/shola/php/classes/user.class.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/Software/Final1/shola/php/classes/Agent.class.php';
