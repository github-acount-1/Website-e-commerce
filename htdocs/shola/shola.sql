...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2017 at 12:48 PM
...
(1, 'Abel', 'Habtsh', 'Abel', '098f6bcd4621d373cade4e832627b4f6', 'abelteferany@gmail.com', '938392729', 'Ethiopia', 'Addis Ababa', '2017-11-28'),
...
(8, 'Hello', 'World', 'Hello', '098f6bcd4621d373cade4e832627b4f6', 'Hello@world.com', '9397829873', 'Ethiopia', 'Addis', '2017-12-04');
...
INSERT INTO `items` (`item_id`, `item_name`, `description`, `quantity`, `model`, `color`, `category`, `post_date`, `contract_period`, `uploader_id`, `weight`, `price`, `old_price`, `split_pay`, `release_date`, `sell_count`, `hit_count`, `rating`) VALUES
(7, 'Ferrari', 'luxury sports car', 10, 'no model', 'none', '7', '2017-12-03', 365, 1, NULL, 10000000, NULL, NULL, NULL, 0, 0, 3),
(8, 'Bugatti', 'Bugatti Veron', 15, 'no model', 'none', '7', '2017-12-03', 365, 1, NULL, 20000000, NULL, NULL, NULL, 0, 0, 2),
(9, 'asdf', 'adsf', 4, 'no model', 'none', '10', '2017-12-04', 4, 1, NULL, 4, NULL, NULL, NULL, 0, 0, 2),
(10, 'Test Item', 'Test rating with this item', 10, 'no model', 'none', '11', '2017-12-04', 365, 1, NULL, 25, NULL, NULL, NULL, 0, 0, 3),
(11, 'Second Test', 'Test if review hides after a user gives a review once', 23, 'no model', 'none', '11', '2017-12-04', 32, 1, NULL, 332, NULL, NULL, NULL, 0, 0, 4),
(12, 'asdfasd', 'asdf', 3, 'no model', 'none', '11', '2017-12-04', 23, 1, NULL, 32, NULL, NULL, NULL, 0, 0, 0),
(13, 'Yabede doro', 'well...', 10, 'no model', 'none', '11', '2017-12-05', 10, 1, NULL, 250, NULL, NULL, NULL, 0, 0, 3);
...
(7, 'img/items/Ferrari/e.jpg', 1),
(8, 'img/items/Bugatti/d.jpg', 1),
(9, 'img/items/asdf/MontBlancVideo_EN-US9230432404_1920x1200.jpg', 1),
(10, 'img/items/Test Item/MinervaTerrace_EN-US9761771059_1920x1200.jpg', 1),
(11, 'img/items/Second Test/VolunteerPoint_EN-US6724349323_1920x1200.jpg', 1),
(12, 'img/items/asdfasd/GreatCourt_EN-US11131065922_1920x1200.jpg', 1),
(13, 'img/items/Yabede doro/FireChicken_EN-US8632578869_1920x1200.jpg', 1);
...
INSERT INTO `parents` (`id`, `user`, `text`, `date`, `code`, `item_id`, `rating`) VALUES
(1, 'Abel', 'It is a nice phone. I enjoyed it.', '2017-12-01 20:32:48', 'XJYLhZ', 1, 5),
(25, 'Abel', 'How', '2017-12-03 01:53:37', 'mliHIg', 3, 0),
(26, 'Abel', 'How', '2017-12-03 01:53:37', 'kvUhot', 3, 0),
(27, 'Abel', 'Nice Iphone', '2017-12-03 02:14:59', '15pPpp', 1, 0),
(28, 'Abel', 'nice', '2017-12-03 02:17:59', '0CHuQX', 2, 0),
(29, 'Abel', 'nice color', '2017-12-03 02:22:10', 'vKiver', 5, 0),
(30, 'Abel', 'Its really good', '2017-12-03 02:22:30', 'fim3sF', 5, 0),
(31, 'a@b.com', 'sd', '2017-12-03 03:42:57', 'i3cXP2', 1, 0),
(32, 'a@b.com', 'Hell', '2017-12-03 03:43:09', 'eGzuP3', 1, 0),
(33, 'a@b.com', 'Hell', '2017-12-03 03:43:09', 'hQwlBJ', 1, 0),
(34, 'a@b.com', 'asdf', '2017-12-03 03:44:52', 'J88gIa', 1, 0),
(35, 'Abel', 'I like it', '2017-12-04 00:26:01', 'hbbxxL', 7, 0),
(36, 'Hello', 'yep', '2017-12-04 22:47:11', 'FcO9Z4', 9, 0),
(37, 'Abel', 'This is a good review.', '2017-12-05 01:51:20', 'xhEUGZ', 7, 5),
(38, 'Abel', 'Nice product', '2017-12-05 02:11:29', 'X6aBm9', 10, 5),
(39, 'Abel', 'Decrease rating', '2017-12-05 02:12:12', 'cAPNBw', 10, 1),
(55, 'Abel', 'asdffasdf', '2017-12-05 04:53:17', '8YS88y', 11, 4),
(72, 'Abel', 'one', '2017-12-05 20:27:26', 'YHfC7B', 13, 3);
...
INSERT INTO `questions` (`id`, `prod_id`, `question`, `answer`, `keywords`, `count`) VALUES
(1, 13, 'what is the price of this thing', 'well about 200', 'a:2:{i:0;s:5:"price";i:1;s:5:"thing";}', 3),
(2, 13, 'how big is this thing', 'Its 25 kg', 'a:2:{i:0;s:3:"big";i:1;s:5:"thing";}', 3);
...
--
-- Table structure for table `shola_info`
--

CREATE TABLE IF NOT EXISTS `shola_info` (
  `info_id` int(11) NOT NULL AUTO_INCREMENT,
  `interest_rate` double DEFAULT NULL,
  `shola_account` bigint(20) DEFAULT NULL,
  `shola_temp_account` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `shola_info`
--

INSERT INTO `shola_info` (`info_id`, `interest_rate`, `shola_account`, `shola_temp_account`, `shola_cut`, `cost_per_hour`) VALUES
(1, 0.1, 10000212549999, 10000212548888, 0.02, 5);
